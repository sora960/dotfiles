...
hl.bind("Print", hl.dsp.exec_cmd("grim -g \"$(slurp)\" - | tee /home/lucy/Pictures/Screenshots/$(date +'%Y-%m-%d_%H-%M-%S').png | wl-copy"))
hl.bind("SHIFT + Print", hl.dsp.exec_cmd("grim - | wl-copy"))
hl.bind(mainMod .. " + SHIFT + R", hl.dsp.exec_cmd("~/.local/bin/screen-record.sh"))

-- Bind SUPER + SHIFT + R to cycle your Quickshell bar instantly
