...
float getBayer(vec2 pos) {
    ...
    if (y == 0) {
        ...
        if (x == 1) return 12.0/16.0;
        if (x == 2) return 3.0/16.0;
        return 15.0/16.0;
    } else if (y == 1) {
        if (x == 0) return 8.0/16.0;
        if (x == 1) return 4.0/16.0;
        if (x == 2) return 11.0/16.0;
        return 7.0/16.0;
    } else if (y == 2) {
        if (x == 0) return 2.0/16.0;
        if (x == 1) return 14.0/16.0;
        if (x == 2) return 1.0/16.0;
        return 13.0/16.0;
    } else {
        if (x == 0) return 10.0/16.0;
        if (x == 1) return 6.0/16.0;
        if (x == 2) return 9.0/16.0;
        return 5.0/16.0;
    }
}
